              ...
              try{
                ...
                if(paymentOption ==="COD"){
                    const {data}= await axios.post('/api.order/cod',{
                        userId: UNSAFE_RouteContext.id,
                        items: cartArray.map(item => ({ product: item._id , quality : item.quantity})),
                                    ...
                                    <div className="font-normal text-gray-500/70">
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <select onChange={e => updateCArtItem(product._id, Number(e.target.value))}
                                                vlaue={cartItems[product._id]} className='outline-none'>
                ...
                <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative flex justify-between items-start mt-2">
                            ...
                            {showAddress && (
                                <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full"> {addresses.map((address, index) => (
