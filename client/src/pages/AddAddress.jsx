 ...
 useEffect(()=>{
  ...
  return (
    <div className='mt-16 pb-16'>
      ...
      <div className='flex flex-col-reverse md:flex-row justify-baseline mt-10'>
            ...
            <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                <InputFiled handleChange={handleChange} address={address} name='lastName' type="text" placeholder="Last Name"/>
                 ...
                 <InputFiled handleChange={handleChange} address={address} name='email' type="text" placeholder="Email"/>
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                     <InputFiled handleChange={handleChange} address={address} name='zipcode' type="text" placeholder="Zipcode"/>
...
<img  className=' md:ml-20 md:mr-16 mb-16 md:mt-0' src={assets.add_address_iamge}
  alt='Add Address'
/>
